...
def check_status(message):
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "🚀 *𝙆𝙀𝙀𝙋 𝙎𝙐𝙋𝙋𝙊𝙍𝙏𝙄𝙉𝙂 𝘼𝙉𝘿 𝙒𝙄𝙉 𝙏𝙃𝙀 𝘽𝘼𝙏𝙏𝙇𝙀!* ⚡️"
    )
...
def reset_attack_limit(message):
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [TOXICPLAYER](https://t.me/TOXICPLAYER002) ⚡️*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002424353848"  # Replace with your actual feedback channel ID
...
# Check if user is exempted from cooldowns, limits, and feedback requirements
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./paid {target_ip} {target_port} {default_duration} 3000")
